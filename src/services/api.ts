...
export const QUICKNODE_RPC = 'https://cold-divine-general.quiknode.pro/943dc7e0f44a7afc38afeea8439163761f42a321/';
...
export const fetchTransactions = async (token: string, minTimestamp?: string, excludeIds: string[] = []): Promise<Request[]> => {
    try {
